...
def eat_ghost(power_pellet_active, touching_ghost):
    ...
    '''If not Touching Ghost always return the pellet is Active'''
    return False
...
def lose(power_pellet_active, touching_ghost):
    ...
    if  not touching_ghost or power_pellet_active or (power_pellet_active and touching_ghost): 
        return False
...
def win(has_eaten_all_dots, power_pellet_active, touching_ghost):
    ...
    """
    eaten = eat_ghost(power_pellet_active, touching_ghost)
    losed  = lose(power_pellet_active, touching_ghost)    

    print(eaten, losed)

    if (not losed and eaten and has_eaten_all_dots) or has_eaten_all_dots : 
        return True
