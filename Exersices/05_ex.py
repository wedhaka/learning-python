...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature < 800.00 and neutrons_emitted > 500.00 and (temperature * neutrons_emitted) < 500000 :
        return True
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    generated_power = (temperature * neutrons_produced_per_second / threshold) * 100

    print(generated_power)
    
    if generated_power > 110 :
        return "DANGER" 
    elif generated_power <= 90 : 
        return "LOW" 
    elif generated_power <= 20 or generated_power >= 0 :
        return "NORMAL" 